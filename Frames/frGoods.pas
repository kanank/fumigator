...
type
  TFrameGoods = class(TFrameListBase)
...
procedure TFrameGoods.btnEditClick(Sender: TObject);
var
...
function TFrameGoods.SaveData: Boolean;
var
...
procedure TFrameGoods.SetServices(ASource: TDataset);
begin
  Query.First;
