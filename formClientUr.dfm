inherited frmClientUr: TfrmClientUr
  Caption = #1050#1072#1088#1090#1086#1095#1082#1072' '#1082#1083#1080#1077#1085#1090#1072'. '#1070#1088'. '#1083#1080#1094#1086
  ClientHeight = 338
  ClientWidth = 824
  ...
  object Passp_pnl: TRzPanel
    ...
    object RSchet_edt: TcxDBMaskEdit
      Left = 40
      Top = 59
      DataBinding.DataField = 'RAS_SCHET'
      Properties.HideSelection = False
      Properties.MaskKind = emkRegExprEx
      Properties.EditMask = '\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d'
      Properties.MaxLength = 0
      Properties.ValidationOptions = [evoShowErrorIcon, evoAllowLoseFocus]
      TabOrder = 5
      Width = 155
    end
    object KorrShet_edt: TcxDBMaskEdit
      Left = 40
      Top = 86
      DataBinding.DataField = 'KOR_SCHET'
      Properties.MaskKind = emkRegExprEx
      Properties.EditMask = '\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d\d'
      Properties.MaxLength = 0
      Properties.ValidationOptions = [evoShowErrorIcon, evoAllowLoseFocus]
  ...
  object Forma_cb: TcxDBComboBox
    Left = 100
    Top = 8
    Anchors = [akLeft, akTop, akRight]
    DataBinding.DataField = 'FORMA'
  ...
  object OrgName_Edt: TcxDBTextEdit
    Left = 151
    Top = 44
    BeepOnEnter = False
  ...
  object RzGroupBox1: TRzGroupBox
    ...
    object cxDBTextEdit1: TcxDBTextEdit
      ...
      Top = 19
      BeepOnEnter = False
      DataBinding.DataField = 'CONTACT_FIO'
